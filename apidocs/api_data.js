define({ "api": [
  ...
  },
  {
    ...
    "description": "<p><code>total</code> parameter represents total amount of related articles. To build a Category Page you can use Categories endpoint and Articles endpoint with filter applied.</p>"
  },
  {
    "type": "post",
    "url": "/news/article/:id/like",
    "title": "Like/Unlike",
    "version": "1.0.0",
    "group": "News",
    "filename": "api/news/views.py",
    "groupTitle": "News",
    "name": "PostNewsArticleIdLike",
    "header": {
      "examples": [
        {
          "title": "Authorization-Example:",
    ...
    "description": "<p>Like/Unlike will be determined based on whether the article was liked or not. For more info about was specific article liked or not you can access <code>Article</code> and <code>Articles</code> endpoints (<code>is_liked</code> param).</p>"
  },
  {
    "type": "post",
    "url": "/auth/login",
